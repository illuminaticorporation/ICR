...
// Copyright (c) 2013 The Illuminati developers
...
uint256 hashGenesisBlock("0x000001c831cdb1b8d82a4f5ef14e782abcf150fe6beed1c86dba13bed05547ed");
static const unsigned int timeGenesisBlock = 1398917464;
...
const string strMessageMagic = "Illuminati Signed Message:\n";
...
static const int64 nGenesisBlockRewardCoin = 100000000 * COIN;
static const int64 nBlockRewardStartCoin = 1277777 * COIN;
static const int64 nBlockRewardMinimumCoin = 925 * COIN;

static const int64 nTargetTimespan = 4350;
static const int64 nTargetSpacing = 435; 
static const int64 nInterval = nTargetTimespan / nTargetSpacing; 

int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
	
    if (nHeight < 21) {return nGenesisBlockRewardCoin;}
    int64 nSubsidy = nBlockRewardStartCoin;

	nSubsidy >>= (nHeight / 18000);
    // Minimum subsidy
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "enlightenment and liberty";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x8b4e341f6303d425f6f4b489d212fcf9163668c6a1e8a5021726c866e3b75f0a"));
...
unsigned char pchMessageStart[4] = { 0x05, 0xfe, 0xfe, 0x03 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("IlluminatiMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("IlluminatiMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("IlluminatiMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("illuminati-miner");
    ...
    try { loop {
        ...
        printf("Running IlluminatiMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("IlluminatiMiner terminated\n");
        throw;
    }
}
