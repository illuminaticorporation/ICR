...
const QString BITCOIN_IPC_PREFIX("illuminati:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click illuminati: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start illuminati: click-to-pay handler");
    else
...
{
    // clicking on illuminati: URLs creates FileOpen events on the Mac:
